...
const Navbar = () => {
  ...
  return (
    <div>
        <div className={`hidden lg:flex items-center w-8/12 h-[4rem] justify-between px-6 cursor-pointer bg-[#edeced] text-[black] lg:fixed z-50" ${router.pathname === "/about" || router.pathname == '/about' ? "w-screen" : ""}`}>
