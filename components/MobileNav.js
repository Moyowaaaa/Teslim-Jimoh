...
const MobileNav = () => {
    ...
    return (
      ...
      <div className='lg:hidden z-50 bg-[#0a192f] text-[#46b1a0]'>
      ...
      <div className={`"top-0 right-0 fixed text-[darkslategrey] bg-[#46b1a0] shadow-lg h-full w-screen z-50 ease-in-out duration-700 " ${openMenu ? " translate-x-0" : " translate-x-full"} `}>
      ...
      <div className='w-full h-4/6'>
        ...
        <Link href ="/about">
        <p onClick={closeMenu} className={`hover:border-b-2 border-[#46b1a0] ${router.pathname === "/about" || router.pathname == '/about' ? " " : ""}` }>about</p>
        </Link>
