...
const ProjectsHeader = () => {
  return (
    <div>
        <div className='w-screen flex items-center lg:w-full h-[4rem] shadow-md shadow-blue-100 cursor-pointer  justify-between px-6 bg-[#edeced] text-[#0a192f] fixed z-50 '>
