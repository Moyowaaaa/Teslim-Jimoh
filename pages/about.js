...
<div className="flex flex-col pt-[4.1rem]  w-11/12 lg:w-6/12 mx-auto">
  ...
  <h2  className="flex   text-2xl text-[#46b1a0]  font-black text-center py-6" >What Can I Do For You?</h2>
  ...
  <div className="flex flex-col gap-12 w-full gap-4 lg:gap-[4rem] pt-12 justify-center lg:flex-row">
      <div className="box1 flex flex-col items-center gap-3 hover:text-[#46b1a0] cursor-pointer">
      ...
      <div className="box2 flex flex-col items-center gap-3 hover:text-[#46b1a0] cursor-pointer">
          <FontAwesomeIcon icon={faSliders} width={25} />
          <p>Software Testing</p>
      </div>

      <div className="box3 flex flex-col items-center gap-3 hover:text-[#46b1a0] cursor-pointer">
      ...
      <h1 className=" font-bold text-2xl text-[#46b1a0] py-6">Skills</h1>

      <div className="w-10/12 mx-auto justify-center py-2 flex gap-[3.5rem] flex-wrap ">

        
      <div className="flex flex-col items-center gap-3 h-[4rem]  hover:text-[#46b1a0] cursor-pointer">
  ...
  <h1 className="w-auto font-bold text-2xl text-[#46b1a0] py-6">Work Experience</h1>
...
<p className="text-sm underline underline-offset-4 decoration-[#46b1a0]">Dec 2020 - Present</p>
...
<p className="text-sm underline underline-offset-4 decoration-[#46b1a0] ">Feb 2020 - Present</p>
...
<li>Design websites based on clients specifications.</li>
  ...
  <h1 className="w-auto font-bold text-2xl text-[#46b1a0] py-6">Contact </h1>


  <div className="w-full mt-[2rem] flex flex-col mx-auto ">
    <form onSubmit={handleSubmit}>
        <div className="flex flex-col gap-4">
            <input type="text" placeholder="Name" className="bg-[#0a192f] border-b-[2px]  focus:border-[#46b1a0] w-full px-2 py-2 outline-none placeholder:text-white focus:placeholder:text-[white] text-[white]"
            value={name}
            onChange={(e)=>setName(e.target.value)}
            
            ></input>

            <input type="text" placeholder="Email" className="bg-[#0a192f] border-b-[2px] text-white focus:border-[#46b1a0] w-full px-2 py-2 outline-none placeholder:text-white focus:placeholder:text-[white] text-[white]"
            value={email}
            onChange={(e)=>setEmail(e.target.value)}
            ></input>

            {/* <input type="text" placeholder="Subject" className="bg-[#edeced] border-b-[2px]  focus:border-[#46b1a0] w-full px-2 py-2 outline-none placeholder:text-black focus:placeholder:text-[darkslategrey]"></input> */}
            
            <textarea placeholder="Message" className="h-36  border-b-[2px] focus:border-[#46b1a0] bg-[#0a192f] resize-none px-2 pt-2 outline-none placeholder:text-white focus:placeholder:text-[white] text-[white]"
             value={message}
...
<a href='https://github.com/teslim191' target="_blank" rel="noreferrer" ><FontAwesomeIcon icon={faGithub} width={15} className="hover:text-[#46b1a0]" /></a>
<a href="https://www.linkedin.com/in/teslim-jimoh-52056818a" target="_blank" rel="noreferrer" ><FontAwesomeIcon icon={faLinkedin} width={15} className='text-[#46b1a0] hover:text-black' /></a>
<a href='https://mobile.twitter.com/Teslim_96' target="_blank" rel="noreferrer" ><FontAwesomeIcon icon={faTwitter} width={15} className="hover:text-[#46b1a0]" /></a>
